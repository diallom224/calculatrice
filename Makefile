...
calculette: analyse_lexicale.o lecture_caracteres.o analyse_syntaxique.o calculette.o
	gcc -g -Wall -o calculette analyse_lexicale.o lecture_caracteres.o analyse_syntaxique.o calculette.o -lm
...
clean:
	rm -f calculette test_lexeme  essai_ast *.o 